...
def generate_launch_description():
    ...
    # Nodo detector_lidar (con delay para asegurar que el bridge esté listo)
    detector_lidar_node = TimerAction(
