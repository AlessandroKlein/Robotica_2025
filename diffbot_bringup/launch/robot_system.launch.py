# /diffbot_bringup/launch/robot_system.launch.py
...
def generate_launch_description():
    ...
    # -----------------------------------------------------
    # Los controladores se definen en diffbot_control/config/controllers.yaml
    ...
    #     Definido en diffbot_control/diffbot_control/cmd_vel_listener.py
    # -----------------------------------------------------
    ...
    #     Definido en diffbot_control/diffbot_control/odometry_publisher.py
    # -----------------------------------------------------
    ...
    #     Definido en diffbot_control/diffbot_control/go_to_pose_controller.py
    # -----------------------------------------------------
