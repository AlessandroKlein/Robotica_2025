...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            declare_left_wheel_joint_name, # Nuevos argumentos
            declare_right_wheel_joint_name, # Nuevos argumentos
            ...
            odometry_publisher_node, # Incluir el nodo de odometría
        ]
    )