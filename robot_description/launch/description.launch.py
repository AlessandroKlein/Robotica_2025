...
def generate_launch_description():
    pkg_share = FindPackageShare('robot_description')  # Buscar el paquete robot_description
    urdf_file = PathJoinSubstitution([pkg_share, 'urdf', 'diffbot.urdf.xacro'])  # Ruta al archivo Xacro
