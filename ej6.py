...
def simular_trayectoria_completa(robot):
    ...
    duracion_giro_1 = 5.0 # segundos (arbitrario, ajustar para velocidad adecuada)
    ...
    velocidad_recta_1 = 0.2 # m/s (arbitrario, ajustar para una duración razonable)
    ...
    duracion_giro_2 = 5.0 # segundos (misma duración que el giro anterior)
    ...
    # Opcional: Marcar los puntos de transición entre segmentos
